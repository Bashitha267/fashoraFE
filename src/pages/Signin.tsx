...
export const Signin = () => {
  return (
    <div className="md:mt-55 mt-38 w-full md:max-w-[160vh] mx-auto px-4 h-screen">
      <div className="lg:grid lg:grid-cols-3 lg:w-11/12 lg:mx-auto lg:h-full">
        <div className="lg:col-span-2 bg-amber-300 lg:flex lg:justify-center lg:items-center">
          <div className="bg-white lg:w-2/3 lg:h-3/5 lg:flex lg:flex-col lg:p-4 p-2">
          <div className="flex justify-center lg:justify-start"><img src={logo} className="w-52 h-32 mb-5 object-contain"></img></div>
          <div className="flex justify-center lg:justify-start text-xl mb-4 font-bold text-gray-400">Welcome Back!!</div>
