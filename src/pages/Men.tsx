...
useEffect(()=>{
  const fetchProduct=async()=>{
    ...
    try{
      const response=await axios.get('https://fashorabe26.onrender.com/getMenColors')
...
useEffect(()=>{
  const fetchProduct=async()=>{
    setloading(true)
    try{
      const response=await axios.get('https://fashorabe26.onrender.com/getMen')
...
if(loading||loadingcolors){
  ...
  return (
    <div className="mt-45 w-screen md:max-w-[160vh] mx-auto max-w-[80%] flex flex-col">
