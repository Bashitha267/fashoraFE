export const NewsLetter = () => {
    return (
        ...
        <div className="mt-32 md:max-w-[160vh] px-6 sm:mt-56 lg:px-8 mx-auto">
          <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-15 shadow-2xl rounded-2xl sm:rounded-3xl sm:px-24 xl:py-32">
